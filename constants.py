"""
このファイル（constants.py）は、固定の文字列や数値などのデータを変数として一括管理するファイルです。
"""
...
# RAG設定
# ==========================================
TEXT_SPLITTER_CHUNK_SIZE = 500        # チャンクサイズ
TEXT_SPLITTER_CHUNK_OVERLAP = 50      # チャンクのオーバーラップ
RETRIEVER_SEARCH_TOP_K = 5            # 1回の検索で取得するドキュメント数
VECTOR_SEARCH_WEIGHT = 0.5            # ベクトル検索の重み
BM25_SEARCH_WEIGHT = 0.5              # BM25検索の重み
...
CSV_ERROR_MESSAGE = "社員名簿CSVの読み込みに失敗しました。"